/**
 * Contains a large list of of constants and functions to allow for 
 * easier conversion between units and spinner position. Also defines 
 * the various return codes to avoid so called 'magic numbers'.
 * 
...
public class Constants {
	...
	// This is actually important... Do not delete! Make sure 
	// That if you add any units, that you also update this!
	 ...
	 * 
	 * @param unit
	 *            String of the unit you want the postition of
	 */
